...
icone = pygame.image.load("recursos/assets/vecna.png")
pygame.display.set_icon(icone)
logo = pygame.image.load("recursos/assets/icone.png").convert_alpha()
...
# Imagens
eleven = pygame.image.load("recursos/assets/eleven.png")
fundoStart = pygame.image.load("recursos/assets/fundoStart.png")
fundoJogo = pygame.image.load("recursos/assets/fundoJogo.png")
fundoDead = pygame.image.load("recursos/assets/fundoVecna.png")
Vecna = pygame.image.load("recursos/assets/vecna.png")

lua_original = pygame.image.load("recursos/assets/lua.png").convert_alpha()
lua = pygame.transform.scale(lua_original, (290, 400))

# Sons e fontes
vecnaSound = pygame.mixer.Sound("recursos/assets/vecnaSound.mp3")
...
pygame.mixer.music.load("recursos/assets/kids.mp3")
...
morcego_img = pygame.image.load("recursos/assets/morcego.png").convert_alpha()
